...
SinglePuncta = SinglePunctaValues(3, 1, 750, 7, 11, 5, 400); // requires 7 variables. ****Enter Values****
// The Channel number
...
// vc404, saves wrong ROIs is the lsit is empty. Added 'if ROI manager = empty' don't save.
